...
class OrderInfo(models.Model):
    user = models.ForeignKey('tt_user.UserInfo')   #用户
    ...
    num_price = models.DecimalField(max_digits=10,decimal_places=2)    #总价格


class OrderGoods(models.Model):
    order = models.ForeignKey('OrderInfo')
    goods_img = models.ImageField()       #图片
    goods_title = models.CharField(max_length=50)     #标题
